...
public class SectorDeck extends Deck {
    ...
    public SectorDeck() {
        ...
        addSectorCardWithNoiseMySector(ConstantsDeck.N_SECTORCARD_NOISE_MY_W_ITEM,0);
        addSectorCardWithNoiseAnySector(ConstantsDeck.N_SECTORCARD_NOISE_ANY_W_ITEM,0);
