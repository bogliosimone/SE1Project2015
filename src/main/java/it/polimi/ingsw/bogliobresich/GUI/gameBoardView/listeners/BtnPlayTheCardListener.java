...
public class BtnPlayTheCardListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        GUIController.sendCommand(new ClientCommand(CommandType.DO_PLAY_ITEM_REQUEST,GUIController.getInstance().getHandOfCards().getCard(GUIController.getInstance().getIdCardSelected())));
    }
}
